...
(define-read-only (get-outflow-inflow)
  (let (
    (next-cycle-info (contract-call? .core-v1 get-cycle-info (+ (get-pox-cycle) u1)))
...
(define-private (stackers-initiate-stacking (stacker-id uint) (pox-address { version: (buff 1), hashbytes: (buff 32) }) (amount uint) (start-burn-height uint))
  (if (is-eq stacker-id u1) (contract-call? .stacker-1 initiate-stacking .reserve-v1 pox-address amount start-burn-height u1)
  (if (is-eq stacker-id u2) (contract-call? .stacker-2 initiate-stacking .reserve-v1 pox-address amount start-burn-height u1)
  (if (is-eq stacker-id u3) (contract-call? .stacker-3 initiate-stacking .reserve-v1 pox-address amount start-burn-height u1)
  (if (is-eq stacker-id u4) (contract-call? .stacker-4 initiate-stacking .reserve-v1 pox-address amount start-burn-height u1)
  (if (is-eq stacker-id u5) (contract-call? .stacker-5 initiate-stacking .reserve-v1 pox-address amount start-burn-height u1)
  (if (is-eq stacker-id u6) (contract-call? .stacker-6 initiate-stacking .reserve-v1 pox-address amount start-burn-height u1)
  (if (is-eq stacker-id u7) (contract-call? .stacker-7 initiate-stacking .reserve-v1 pox-address amount start-burn-height u1)
  (if (is-eq stacker-id u8) (contract-call? .stacker-8 initiate-stacking .reserve-v1 pox-address amount start-burn-height u1)
  (if (is-eq stacker-id u9) (contract-call? .stacker-9 initiate-stacking .reserve-v1 pox-address amount start-burn-height u1)
  (if (is-eq stacker-id u10) (contract-call? .stacker-10 initiate-stacking .reserve-v1 pox-address amount start-burn-height u1)
    (ok u0)
  ))))))))))
)
...
(define-private (stackers-stack-extend (stacker-id uint) (pox-address { version: (buff 1), hashbytes: (buff 32) }))
  (if (is-eq stacker-id u1) (contract-call? .stacker-1 stack-extend u1 pox-address)
  (if (is-eq stacker-id u2) (contract-call? .stacker-2 stack-extend u1 pox-address)
  (if (is-eq stacker-id u3) (contract-call? .stacker-3 stack-extend u1 pox-address)
  (if (is-eq stacker-id u4) (contract-call? .stacker-4 stack-extend u1 pox-address)
  (if (is-eq stacker-id u5) (contract-call? .stacker-5 stack-extend u1 pox-address)
  (if (is-eq stacker-id u6) (contract-call? .stacker-6 stack-extend u1 pox-address)
  (if (is-eq stacker-id u7) (contract-call? .stacker-7 stack-extend u1 pox-address)
  (if (is-eq stacker-id u8) (contract-call? .stacker-8 stack-extend u1 pox-address)
  (if (is-eq stacker-id u9) (contract-call? .stacker-9 stack-extend u1 pox-address)
  (if (is-eq stacker-id u10) (contract-call? .stacker-10 stack-extend u1 pox-address)
   (ok u0)
  ))))))))))
)

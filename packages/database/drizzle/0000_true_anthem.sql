DO $$ BEGIN
 CREATE TYPE "points_source" AS ENUM('migration', 'referral', 'ststx', 'bitflow', 'zest', 'arkadiko', 'velar', 'hermetica');
EXCEPTION
...
CREATE TABLE IF NOT EXISTS "points_earned" (
	...
	CONSTRAINT "points_earned_wallet_block_hash_source_unique" UNIQUE("wallet","block_hash","source")
);
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "referrals" (
	"id" serial PRIMARY KEY NOT NULL,
	"address" varchar NOT NULL,
	"stacker" varchar NOT NULL,
	"block_height" integer NOT NULL,
	CONSTRAINT "referrals_address_stacker_unique" UNIQUE("address","stacker")
);
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "referrals" ADD CONSTRAINT "referrals_address_wallets_address_fk" FOREIGN KEY ("address") REFERENCES "wallets"("address") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "referrals" ADD CONSTRAINT "referrals_stacker_wallets_address_fk" FOREIGN KEY ("stacker") REFERENCES "wallets"("address") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;

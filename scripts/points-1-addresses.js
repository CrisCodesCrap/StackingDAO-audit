...
async function start() {
  ...
  await utils.writeFile('points-addresses-5', {"addresses": addresses})
  ...
  await utils.writeFile('points-referrals-5', referrers)

  await utils.writeFile('points-last-block-addresses-5', { last_block: currentBlockHeight })
};

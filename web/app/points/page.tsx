...
export default function Points() {
  ...
  async function fetchBlockInfo() {
    const lastBlockResponse = await fetch("https://stackingdao-points.s3.amazonaws.com/points-last-block-5.json");
  ...
  async function fetchPointsInfo() {
    const url = "https://stackingdao-points.s3.amazonaws.com/points-aggregate-5.json";

      ...
      <div className="bg-white py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            <h2 className="text-base font-semibold leading-7 text-ststx">A special genesis NFT for our earliest adopters</h2>
              ...
              <>
                {canClaim && hasClaimed ? (
                  <span>
                    ...
                    <h2 className="mt-6 text-lg font-semibold text-gray-600">Congrats on claiming your NFT.</h2>
                    <p className="mt-1 text-lg font-semibold text-gray-600">A secret multiplier will be applied to your points later.</p>
                    <img src="/genesis-nft.png" className="flex flex-col items-center mt-8" />
                  </span>
                ) : canClaim ? (
                  <span>
                    <h1 className="mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl">🎇🎇🎇</h1>
                    <h2 className="mt-6 text-xl font-semibold text-gray-600">Congrats, you are eligible for the Genesis NFT claim.</h2>
                    <button
                  ...
                  <span>
                    <h1 className="mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl">:(</h1>
                    <h2 className="mt-6 text-xl font-semibold text-gray-600">Sorry, you are not eligible for the Genesis NFT claim.</h2>
                  </span>
                )}
              </>
            )}

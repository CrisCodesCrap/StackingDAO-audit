    ...
    <>
      ...
      {stxAddress ? (
        <div className="w-full min-h-full flex flex-col md:max-w-xl items-center">
            ...
            <div className="flex gap-0.5 h-5 w-full mt-3">
              <div
                ...
                style={{
                  width: `${stStxWidth}%`,
                  backgroundImage:
                    'linear-gradient(45deg, rgba(49,141,139,255) 25%, rgba(49,141,139,255) 25%, rgba(49,141,139,255) 50%, rgba(49,141,139,255) 50%, rgba(49,141,139,255) 75%, rgba(49,141,139,255) 75%, rgba(49,141,139,255) 100%)',
              ...
              <div
                className="h-full rounded"
                style={{
                  width: `${100 - stStxWidth}%`,
                  backgroundImage:
                    'linear-gradient(45deg, rgb(210, 220, 227) 25%, rgb(202, 214, 211) 25%, rgb(202, 214, 211) 50%, rgb(210, 220, 227) 50%, rgb(210, 220, 227) 75%, rgb(202, 214, 211) 75%, rgb(202, 214, 211) 100%)',
                  backgroundSize: '10px 10px',
                }}
              ></div>
            </div>
            ...
            <div className="mt-4 mb-4 grid grid-cols-1 sm:grid-cols-2">
              <div className="mt-1 flex gap-2 items-center font-semibold">
                ...
                <button
                  ...
                  className="text-base w-fit flex gap-1 rounded-full px-2 items-center font-bold bg-light-ststx text-ststx"
                >
                  APY {stackingApy}%
                  <svg
                    stroke="currentColor"
                    ...
                    strokeWidth="0"
                    viewBox="0 0 512 512"
                    className="w-4 h-4 text-opacity-60"
                    height="1em"
                    width="1em"
          ...
          <Link
            href="/unstack"
            className={`flex gap-2 items-center justify-center rounded-full px-6 font-bold focus:outline-none min-h-[48px] text-lg ${
              stStxBalance > 0 ? 'bg-ststx' : 'bg-light-ststx'
            } text-white active:bg-button-active hover:bg-button-hover disabled:bg-opacity-50 my-4 w-full mt-14`}
            style={{
        ...
        <div className="w-full md:max-w-xl min-h-full flex flex-col px-2 pb-10 items-center">
          <div className="rounded-xl w-full p-4">
            ...
            <button
              type="button"
              className="flex gap-2 items-center justify-center rounded-full px-6 font-bold focus:outline-none min-h-[48px] text-lg bg-ststx text-white active:bg-button-active hover:bg-button-hover disabled:bg-opacity-50 w-full mb-2"

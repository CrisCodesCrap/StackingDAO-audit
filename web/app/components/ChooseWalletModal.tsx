                ...
                <div>
                  <div>
                    <div className="flex items-center justify-between">
                      <Dialog.Title
                        as="h1"
                        className="text-lg leading-6 sm:text-2xl font-headings text-sd-gray-darker"
                      >
                        Choose wallet
                      </Dialog.Title>
                      <button
                      ...
                      >
                        <span>
                          ...
                          >
                            ...
                            />
                            <path
                              d="M27.5837 14.7122H33.1279C33.4579 14.7122 33.7219 14.9762 33.7219 15.3062V20.8503C33.7219 21.3783 34.3819 21.6423 34.7119 21.2463L42.302 13.6562C42.4341 13.5242 42.5001 13.3922 42.5001 13.2602V6.59403C42.5001 6.264 42.2362 6 41.9062 6H35.174C35.0419 6 34.844 6.066 34.778 6.198L27.1877 13.7222C26.7917 14.0522 27.0557 14.7122 27.5837 14.7122Z"
                              fill="#EE7A30"
                            />
                          </svg>
                        </span>
                          ...
                          >
                            ...
                            <defs>
                              ...
                              >
                                ...
                                <feGaussianBlur
                                  stdDeviation="5.75"
                                  result="effect1_foregroundBlur_2402_17"
                                />
                              </filter>
                              <filter
                                id="filter1_f_2402_17"
                                x="-9.54639"
                                y="-11.5"
                                width="67.0928"
                                height="65"
                              ...
                              <radialGradient
                                ...
                                r="1"
                                gradientUnits="userSpaceOnUse"
                                gradientTransform="translate(24 21) rotate(180) scale(19.5464 1336.62)"
                              >

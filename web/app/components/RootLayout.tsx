      ...
      <header>
        <nav className="mx-auto flex max-w-7xl items-center justify-between lg:px-8" aria-label="Global">
          ...
          <Popover.Group className="hidden lg:flex lg:gap-x-12 mt-2">
            ...
            <Link className={`flex h-fit pb-2 gap-2 items-center font-semibold ${pathname === '/genesis' ? 'text-ststx' : 'text-gray-700'}`} href="/genesis">
              <svg className={`${pathname === '/genesis' ? 'text-ststx' : 'text-gray-700'}`}  width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path fillRule="evenodd" clipRule="evenodd" d="M2 4C2 2.89543 2.89543 2 4 2H20C21.1046 2 22 2.89543 22 4V20C22 21.1046 21.1046 22 20 22H4C2.89543 22 2 21.1046 2 20V4ZM9.5 15C12.5376 15 15 12.5376 15 9.5C15 6.46243 12.5376 4 9.5 4C6.46243 4 4 6.46243 4 9.5C4 12.5376 6.46243 15 9.5 15ZM4.5 17C4.22386 17 4 17.2239 4 17.5V19.5C4 19.7761 4.22386 20 4.5 20H19.5C19.7761 20 20 19.7761 20 19.5V17.5C20 17.2239 19.7761 17 19.5 17H4.5Z" />
                <path d="M11.5373 12L10.4765 10.3927H12V9.78633H7V10.3934H8.52297L7.4625 12H8.25359L9.5 10.1117L10.7463 12H11.5373ZM11.9999 9.19773V8.58523H10.5074L11.5537 7H10.7627L9.49992 8.91312L8.23727 7H7.44625L8.49391 8.58672H7V9.19773H11.9999Z" />
              </svg>
              <div className="text-base">Genesis NFT</div>
            </Link>

      ...
      <div className="flex items-center justify-between">
        ...
        >
          <Logomark
            ...
            filled={logoHovered}
          />
          <div className="flex items-center hidden h-8 sm:block">
            <Logo
        ...
        <div className="flex justify-center items-center gap-7">
          <Link className={`flex h-fit pt-3 pb-2 gap-2 items-center font-semibold border-b-4 ${pathname === '/' ? 'text-primary border-primary' : 'border-transparent'}`} href="/">

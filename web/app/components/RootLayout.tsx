      ...
      <header>
        <nav className="flex items-center justify-between mx-auto max-w-7xl" aria-label="Global">
          ...
          <Popover.Group className="hidden mt-2 lg:flex lg:gap-x-12">
            ...
            <Link className={`flex h-fit pb-2 gap-2 items-center font-semibold ${pathname === '/' || pathname === '/stack' || pathname === '/unstack' ? 'text-dark-green-600' : 'text-gray-500'}`} href="/">
              {pathname === '/' || pathname === '/stack' || pathname === '/unstack'
                ?
                <svg className="w-2 h-2 text-fluor-green-500" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <Link className={`flex h-fit pb-2 gap-2 items-center font-semibold ${pathname === '/points' ? 'text-dark-green-600' : 'text-gray-500'}`} href="/points">
              {pathname === '/points'
                ?
                <svg className="w-2 h-2 text-fluor-green-500" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="4" cy="4" r="4" fill="currentColor"/>
            ...
            <Link className={`flex h-fit pb-2 gap-2 items-center font-semibold ${pathname === '/defi' ? 'text-dark-green-600' : 'text-gray-500'}`} href="/defi">
              {pathname === '/defi'
                ?
                <svg className="w-2 h-2 text-fluor-green-500" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="4" cy="4" r="4" fill="currentColor"/>

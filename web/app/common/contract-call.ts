...
import { ClarityValue, PostCondition, PostConditionMode, cvToHex, serializePostCondition } from "@stacks/transactions";
...
export async function makeContractCall(options: ContractCallOptions, onComplete: (error?: any, txId?: any) => void) {
